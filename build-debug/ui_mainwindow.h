...
"}"));
        ...
        layoutWidget->setGeometry(QRect(40, 150, 331, 471));
...
"}"));
        ...
        gridLayout->addWidget(del, 2, 1, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(mr, 1, 3, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(m_minus, 1, 2, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(m_add, 1, 1, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(FB, 0, 1, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(BB, 0, 2, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(mc, 1, 0, 1, 1);

        C = new QPushButton(layoutWidget);
        C->setObjectName(QString::fromUtf8("C"));
        C->setMinimumSize(QSize(54, 54));
        C->setMaximumSize(QSize(60, 60));
        C->setFont(font);
...
"}"));
        ...
        textEdit->setGeometry(QRect(40, 10, 331, 81));
...
"}"));
        ...
        lineEdit->setGeometry(QRect(40, 90, 331, 51));
